        ...
        * {
        ...
        .hero-side {
            ...
            background: linear-gradient(135deg, rgba(19, 21, 26, 0.95), rgba(19, 21, 26, 0.8)), 
                        url('https://source.unsplash.com/featured/1200x800?indonesia,landscape') center/cover;
            display: flex;
    ...
    <div class="page-container">
        <section class="hero-side">
            ...
            <div class="hero-content">
                ...
                <p class="hero-text">
                    Jelajahi keindahan tersembunyi Indonesia bersama kami. Temukan destinasi menakjubkan, 
                    nikmati pengalaman autentik, dan ciptakan kenangan tak terlupakan di setiap sudut Nusantara.
                </p>
        ...
        <section class="login-side">
            <div class="login-header">
                ...
                <p class="login-subtitle">Masuk untuk memulai petualangan Anda</p>
            </div>
            ...
            <form id="loginForm" action="/login" method="POST">
                ...
                <div class="form-options">
                    ...
                    <a href="/auth/forgot-password" class="forgot-link">Lupa password?</a>
                </div>
                ...
                <div class="register-section">
                    ...
                    <a href="/register" class="btn-register">Bergabung Sekarang</a>
                </div>
            </form>
        </section>
    </div>
        ...
        document.getElementById('loginForm').addEventListener('submit', async function(e) {
            ...
            try {
                ...
                if (data.status === 'success') {
                    Swal.fire({
                        icon: 'success',
                        title: 'Selamat Datang di LokaNesia!',
                        text: 'Petualangan Anda menanti...',
                        timer: 1500,
                ...
                Swal.fire({
                    icon: 'error',
                    title: 'Gagal Masuk',
                    text: error.message || 'Mohon periksa kembali email dan password Anda',
